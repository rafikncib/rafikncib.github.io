            ...
            <div className="container pt-5">
                <header className="text-center">
                    ...
                    <div className="hstack gap-3 justify-content-center">
                        ...
                        <button type="button" className={`btn ${buildedProjects!=='reactJs'?'bg-black':' btn-danger'}`} onClick={()=>handleClick("reactJs")}>Experience</button>
                        <button type="button" className={`btn ${buildedProjects!=='python'?'bg-black':' btn-danger'}`} onClick={()=>handleClick("python")}>Experience</button>
                    </div>
                </header>
                {
